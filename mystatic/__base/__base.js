...
function search(e){
  let inText = document.querySelector('.searchbar_text').value;
...
function qualityToggle(e) {
  ...
  inQuality.innerHTML = e.target.innerText;
}
let NavbarToggleList = Array.from(document.querySelectorAll('.dropdown-item'));
NavbarToggleList.map(item => item.addEventListener('click',qualityToggle));
